...
FiltBranch1 = Canvas.GatComponentByName('Rectangle Optical Filter');
FiltBranch2 = Canvas.GatComponentByName('Rectangle Optical Filter_1');
...
FiltBranch2.SetParameterValue('Frequency',centFreq-modFreq/1000);
